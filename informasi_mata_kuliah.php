<?php 
  ...
  $result_nilai2 = nilai("SELECT * FROM tb_matkul WHERE semester = 2");
  $result_nilai4 = nilai("SELECT * FROM tb_matkul WHERE semester = 4");
  $result_nilai6 = nilai("SELECT * FROM tb_matkul WHERE semester = 6");
  $result_nilai8 = nilai("SELECT * FROM tb_matkul WHERE semester = 8");
...
<html lang="en">
  ...
  <body>
    ...
    <table class="table table-bordered" style="margin-top: 5rem;">
      ...
      <?php foreach ($result_nilai2 as $nilai) :?>
        <tr>
      ...
      <?php foreach ($result_nilai4 as $nilai) :?>
        <tr>
          <td><?php echo $nilai['kode']; ?></td>
          <td><?php echo $nilai['matkul']; ?></td>
          <td><?php echo $nilai['nama_dosen']; ?></td>
      ...
      <?php foreach ($result_nilai6 as $nilai) :?>
        <tr>
          <td><?php echo $nilai['kode']; ?></td>
          <td><?php echo $nilai['matkul']; ?></td>
          <td><?php echo $nilai['nama_dosen']; ?></td>
      ...
      <?php foreach ($result_nilai8 as $nilai) :?>
        <tr>
          <td><?php echo $nilai['kode']; ?></td>
          <td><?php echo $nilai['matkul']; ?></td>
          <td><?php echo $nilai['nama_dosen']; ?></td>
