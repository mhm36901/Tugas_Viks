<?php 
  ...
  $krs1 = query('SELECT * FROM tb_matkul WHERE semester = 2');
  $krs3 = query('SELECT * FROM tb_matkul WHERE semester = 4');
  $krs5 = query('SELECT * FROM tb_matkul WHERE semester = 6');
  $krs7 = query('SELECT * FROM tb_matkul WHERE semester = 8');
...
<!--                       <form method="post" action="print_krs.php">
                        <button type="submit" class="btn btn-primary" name="cek">Cek Validasi</button>
                      </form> -->
                    </div>
                  </div>
                </div>
